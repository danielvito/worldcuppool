...
if ( ! function_exists('___'))
{
	...
	function ___($string, $context = 0, $values = NULL, $lang = NULL)
	{
		...
		if ($i18n === NULL)
		{
			...
			require_once Kohana::find_file('classes/i18n', 'core', 'php');
			require_once Kohana::find_file('classes/i18n/reader', 'kohana', 'php');
			require_once Kohana::find_file('classes/i18n/reader', 'interface', 'php');
			require_once Kohana::find_file('classes/i18n/plural', 'one', 'php');
			require_once Kohana::find_file('classes/i18n/plural', 'interface', 'php');
